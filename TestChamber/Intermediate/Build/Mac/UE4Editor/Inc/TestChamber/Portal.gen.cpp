...
// Cross Module References
	TESTCHAMBER_API UClass* Z_Construct_UClass_APortal_NoRegister();
	TESTCHAMBER_API UClass* Z_Construct_UClass_APortal();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APortal_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_APortal_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(APortal, 3867262281);
	template<> TESTCHAMBER_API UClass* StaticClass<APortal>()
	{
		return APortal::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APortal(Z_Construct_UClass_APortal, &APortal::StaticClass, TEXT("/Script/TestChamber"), TEXT("APortal"), false, nullptr, nullptr, nullptr);
